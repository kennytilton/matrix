# MatrixCLJS [TodoFRP](https://github.com/lynaghk/todoFRP)

Welcome to a proof-of-concept implementation of the [TodoMVC Classic](https://github.com/tastejs/todomvc/blob/master/app-spec.md), the concept being...
