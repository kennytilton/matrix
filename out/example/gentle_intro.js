...
return example.gentle_intro.gentle_intro_to_Tag.call(null);
});
...
var todos_50791 = tiltontec.cell.core.c_in.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["wash car","mow lawn"], null));
tiltontec.util.core.pln.call(null,"wrapped value:",tiltontec.cell.evaluate.c_get.call(null,todos_50791));

tiltontec.cell.core.c_reset_BANG_.call(null,todos_50791,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["learn Mandarin"], null));

tiltontec.util.core.pln.call(null,"changed value:",tiltontec.cell.evaluate.c_get.call(null,todos_50791));
...
var todos_50792 = tiltontec.cell.core.c_in.call(null,null,new cljs.core.Keyword(null,"obs","obs",-664011444),(function (slot,me,new_value,prior_value,cell){
...
tiltontec.cell.core.c_reset_BANG_.call(null,todos_50792,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["wash dog","learn Mandarin"], null));
...
var _STAR_par_STAR_50782 = tiltontec.model.core._STAR_par_STAR_;
...
var _STAR_par_STAR_50784 = tiltontec.model.core._STAR_par_STAR_;
...
var _STAR_par_STAR_50786 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
var _STAR_par_STAR_50788 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50788;
}});})(x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50782,me,cell,slot_name,cache))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$3 = tiltontec.tag.gen.make_tag.call(null,"p",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"Edit todomx/gentle_intro.cljs line 95 to try other examples.")),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50782,me,cell,slot_name,cache){
return (function (slot_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
var cell__$1 = slot_c_SHARP___$1;
var slot_name__$1 = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP___$1);
...
var _STAR_par_STAR_50790 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,"Edit todomx/gentle_intro.cljs line 95 to try other examples."))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50790;
}});})(x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50782,me,cell,slot_name,cache))
));
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50782;
}})))], null));
});
...
var _STAR_par_STAR_50793 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me;
...
var _STAR_par_STAR_50795 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
var _STAR_par_STAR_50797 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50797;
}});})(x__7615__auto__,_STAR_par_STAR_50793,me,cell,slot_name,cache,todos,add_todo,clear_todos,todo_count,todos_empty,html_hidden))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$2 = tiltontec.tag.gen.make_tag.call(null,"p",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"(see JS console for output)->")),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50793,me,cell,slot_name,cache,todos,add_todo,clear_todos,todo_count,todos_empty,html_hidden){
return (function (slot_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
var cell__$1 = slot_c_SHARP___$1;
var slot_name__$1 = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP___$1);
...
var _STAR_par_STAR_50799 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,"(see JS console for output)->"))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50799;
}});})(x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50793,me,cell,slot_name,cache,todos,add_todo,clear_todos,todo_count,todos_empty,html_hidden))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$3 = tiltontec.tag.gen.make_tag.call(null,"p",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"Edit todomx/gentle_intro.cljs line 95 to try other examples.")),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50793,me,cell,slot_name,cache,todos,add_todo,clear_todos,todo_count,todos_empty,html_hidden){
return (function (slot_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
...
var _STAR_par_STAR_50801 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,"Edit todomx/gentle_intro.cljs line 95 to try other examples."))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50801;
}});})(x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50793,me,cell,slot_name,cache,todos,add_todo,clear_todos,todo_count,todos_empty,html_hidden))
));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__7615__auto____$3);
})(),x__7615__auto____$2);
})(),x__7615__auto____$1);
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50793;
...
return tiltontec.model.core.make.call(null,new cljs.core.Keyword("example.gentle-intro","dummyApp","example.gentle-intro/dummyApp",-1074745508),new cljs.core.Keyword(null,"mx-dom","mx-dom",-1445377107),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tiltontec.tag.gen.make_tag.call(null,"div",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),cljs.core.list(new cljs.core.Symbol(null,"h1","h1",-256355935,null),cljs.core.PersistentArrayMap.EMPTY,"Gentle Intro: Models"),cljs.core.list(new cljs.core.Symbol(null,"p","p",1791580836,null),cljs.core.PersistentArrayMap.EMPTY,"Models: objects with cells as properties"),cljs.core.list(new cljs.core.Symbol(null,"p","p",1791580836,null),cljs.core.PersistentArrayMap.EMPTY,"(see JS console for output)->"),cljs.core.list(new cljs.core.Symbol(null,"p","p",1791580836,null),cljs.core.PersistentArrayMap.EMPTY,"Edit todomx/gentle_intro.cljs line 95 to try other examples."))),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (to_do){
return (function (slot_c_SHARP_){
var me = tiltontec.cell.base.c_model.call(null,slot_c_SHARP_);
var cell = slot_c_SHARP_;
var slot_name = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP_);
...
var _STAR_par_STAR_50802 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me;
...
var _STAR_par_STAR_50804 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
var _STAR_par_STAR_50806 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50806;
}});})(x__7615__auto__,_STAR_par_STAR_50802,me,cell,slot_name,cache,to_do))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$2 = tiltontec.tag.gen.make_tag.call(null,"p",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"(see JS console for output)->")),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50802,me,cell,slot_name,cache,to_do){
return (function (slot_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
var cell__$1 = slot_c_SHARP___$1;
var slot_name__$1 = tiltontec.cell.base.c_slot.call(null,slot_c_SHARP___$1);
...
var _STAR_par_STAR_50808 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,"(see JS console for output)->"))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50808;
}});})(x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50802,me,cell,slot_name,cache,to_do))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$3 = tiltontec.tag.gen.make_tag.call(null,"p",cljs.core.PersistentArrayMap.EMPTY,tiltontec.cell.core.make_c_formula.call(null,new cljs.core.Keyword(null,"code","code",1586293142),cljs.core.list(cljs.core.list(new cljs.core.Symbol("clojure.core","assert","clojure.core/assert",1581062626,null),new cljs.core.Symbol(null,"me","me",1501524834,null),"no me for c?kids"),cljs.core.list(new cljs.core.Symbol("tiltontec.model.core","the-kids","tiltontec.model.core/the-kids",-1146365346,null),"Edit todomx/gentle_intro.cljs line 95 to try other examples.")),new cljs.core.Keyword(null,"value","value",305978217),tiltontec.cell.base.unbound,new cljs.core.Keyword(null,"rule","rule",729973257),((function (x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50802,me,cell,slot_name,cache,to_do){
return (function (slot_c_SHARP___$1){
var me__$1 = tiltontec.cell.base.c_model.call(null,slot_c_SHARP___$1);
...
var _STAR_par_STAR_50810 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
return cljs.core.doall.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,"Edit todomx/gentle_intro.cljs line 95 to try other examples."))));
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50810;
}});})(x__7615__auto____$2,x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50802,me,cell,slot_name,cache,to_do))
));
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__7615__auto____$3);
})(),x__7615__auto____$2);
})(),x__7615__auto____$1);
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50802;
}});})(to_do))
))], null));
});
...
return tiltontec.model.core.md_get.call(null,p1__50811_SHARP_,new cljs.core.Keyword(null,"completed","completed",-486056503));
});})(to_do))
;
var title = ((function (to_do,completed){
return (function (p1__50812_SHARP_){
return tiltontec.model.core.md_get.call(null,p1__50812_SHARP_,new cljs.core.Keyword(null,"title","title",636505583));
});})(to_do,completed))
;
...
var _STAR_par_STAR_50813 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me;
...
var _STAR_par_STAR_50815 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
var _STAR_par_STAR_50817 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50817;
}});})(x__7615__auto__,_STAR_par_STAR_50813,me,cell,slot_name,cache,to_do,completed,title))
));
return cljs.core._conj.call(null,(function (){var x__7615__auto____$2 = tiltontec.tag.gen.make_tag.call(null,"p",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"onclick","onclick",1297553739),((function (x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50813,me,cell,slot_name,cache,to_do,completed,title){
return (function (){
var _STAR_tag_trace_STAR_50820 = tiltontec.tag.html._STAR_tag_trace_STAR_;
...
}finally {tiltontec.tag.html._STAR_tag_trace_STAR_ = _STAR_tag_trace_STAR_50820;
}});})(x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50813,me,cell,slot_name,cache,to_do,completed,title))
...
var _STAR_par_STAR_50821 = tiltontec.model.core._STAR_par_STAR_;
tiltontec.model.core._STAR_par_STAR_ = me__$1;
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50821;
}});})(x__7615__auto____$1,x__7615__auto__,_STAR_par_STAR_50813,me,cell,slot_name,cache,to_do,completed,title))
));
...
}finally {tiltontec.model.core._STAR_par_STAR_ = _STAR_par_STAR_50813;
