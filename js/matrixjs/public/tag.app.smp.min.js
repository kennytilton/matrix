...
Model.prototype.mDeadp=function(){return this.state===kDead};window.Model=Model;Model.prototype.awaken=Model.prototype.awaken;var isModel=function(b){return b instanceof Model};function mkm(b,c,d,e,f){f=void 0===f?"Model":f;clg("mkm sees ",c,f);d=Object.assign({},d,e?{kids:cKids(e)}:null);b=new window[f](b,c,d);if(!isModel(b))throw"mkm made not-modelp";return b}window.mkm=mkm;
function pkdFlat(b,c){c=void 0===c?[]:c;for(var d=0;d<b.length;++d)null!=b[d]&&(b[d]instanceof Array?pkdFlat(b[d],c):c.push(b[d]));return c}function cKids(b,c){c=void 0===c?{}:c;return Object.assign(new Cell(null,function(c){if(!isModel(c.md))throw"ckids c.md not model";c=kfExpand(c,b);return c instanceof Array?pkdFlat(c):[c]},!1,!1,null),c)}window.cKids=cKids;var kfExpandFinal=function(b){return null===b||isModel(b)||b instanceof Array&&b.every(kfExpandFinal)};
...
MXStorable.prototype["delete"]=MXStorable.prototype.delete;MXStorable.prototype.loadAllItems=MXStorable.prototype.loadAllItems;
