  ...
  (:require
    ...
    [tiltontec.web-mx.api
     :refer [evt-md tag-dom-create
             section header h1 input footer p a span label ul li div button br]]
...
(def app-help-entry
  ["Click any job header to show or hide the full listing."
   ...
   "Built with <a href='https://github.com/kennytilton/matrix/blob/main/js/matrix/readme.md'>Matrix Inside</a>&trade;."
