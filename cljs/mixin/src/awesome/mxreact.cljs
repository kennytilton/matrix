...
(defmethod not-to-be [::awesome.elt] [me]
...
(defmethod observe-by-type [::awesome.elt] [slot me newv oldv cell]
  ; (prn :obs-type-awesome-elt-entry slot (mget me :name)(mget me :sid))
