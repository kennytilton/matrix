(ns matrixrn.demo.tutorial.x120-web-component.core
  (:require
    [react]
    ...
    [matrixrn.demo.tutorial.x120-web-component.lesson :as lesson]
    [matrixrn.demo.tutorial.x120-web-component.decimal-display :as dec]
    [matrixrn.demo.tutorial.x120-web-component.thumb-color :as thumb]
    [matrixrn.demo.tutorial.x120-web-component.rgb-slider :as slider]))
