...
var G__12802 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12802,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12802;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12804){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12805,G__12806,seq12804__$2);
}));
...
var file = cljs.core.get.call(null,map__12811__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12811__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12811__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__12810_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12810_SHARP_));
...
var temp__5720__auto___12813 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12813)){
var message_12814 = temp__5720__auto___12813;
cljs.core.println.call(null,message_12814);
} else {
}
...
var temp__5720__auto___12815 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12815)){
var message_12816 = temp__5720__auto___12815;
cljs.core.println.call(null,message_12816);
} else {
}
...
var output_dir__$1 = (function (){var G__12817 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12817,"/"].join('');
} else {
return G__12817;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__12819 = exception.stack;
var G__12819__$1 = (((G__12819 == null))?null:clojure.string.split_lines.call(null,G__12819));
var G__12819__$2 = (((G__12819__$1 == null))?null:cljs.core.get.call(null,G__12819__$1,depth));
if((G__12819__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12819__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__12820 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12820,(0),null);
var column = cljs.core.nth.call(null,vec__12820,(1),null);
var vec__12823 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12823,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12823,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12823,(2),null);
...
var m__$1 = (function (){var G__12826 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12830 = (function (){var G__12829 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12829);
} else {
return G__12829;
}
})();
...
return cljs.core.vary_meta.call(null,G__12831,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e12832){var e = e12832;
var G__12833 = e;
var G__12833__$1 = (((G__12833 instanceof cljs.core.Keyword))?G__12833.fqn:null);
switch (G__12833__$1) {
...
var vec__12835 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12835,(0),null);
var types = vec__12835;
...
return cljs.core.map.call(null,(function (p__12838){
var vec__12839 = p__12838;
var ns = cljs.core.nth.call(null,vec__12839,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12839,(1),null);
return (function (){
...
var G__12842 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__12843 = cljs.core.seq.call(null,vars__$1);
var chunk__12844 = null;
var count__12845 = (0);
var i__12846 = (0);
while(true){
if((i__12846 < count__12845)){
var v = cljs.core._nth.call(null,chunk__12844,i__12846);
var temp__5720__auto___12848 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12848)){
var t_12849 = temp__5720__auto___12848;
each_fixture_fn.call(null,((function (seq__12843,chunk__12844,count__12845,i__12846,t_12849,temp__5720__auto___12848,v,each_fixture_fn,G__12842,G__12842__$1,env,once_fixtures,each_fixtures,vec__12839,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12849)));
});})(seq__12843,chunk__12844,count__12845,i__12846,t_12849,temp__5720__auto___12848,v,each_fixture_fn,G__12842,G__12842__$1,env,once_fixtures,each_fixtures,vec__12839,ns,vars__$1))
);
} else {
}


var G__12850 = seq__12843;
var G__12851 = chunk__12844;
var G__12852 = count__12845;
var G__12853 = (i__12846 + (1));
seq__12843 = G__12850;
chunk__12844 = G__12851;
count__12845 = G__12852;
i__12846 = G__12853;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__12843);
if(temp__5720__auto__){
var seq__12843__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12843__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__12843__$1);
var G__12854 = cljs.core.chunk_rest.call(null,seq__12843__$1);
var G__12855 = c__4556__auto__;
var G__12856 = cljs.core.count.call(null,c__4556__auto__);
var G__12857 = (0);
seq__12843 = G__12854;
chunk__12844 = G__12855;
count__12845 = G__12856;
i__12846 = G__12857;
continue;
} else {
var v = cljs.core.first.call(null,seq__12843__$1);
var temp__5720__auto___12858__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12858__$1)){
var t_12859 = temp__5720__auto___12858__$1;
each_fixture_fn.call(null,((function (seq__12843,chunk__12844,count__12845,i__12846,t_12859,temp__5720__auto___12858__$1,v,seq__12843__$1,temp__5720__auto__,each_fixture_fn,G__12842,G__12842__$1,env,once_fixtures,each_fixtures,vec__12839,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12859)));
});})(seq__12843,chunk__12844,count__12845,i__12846,t_12859,temp__5720__auto___12858__$1,v,seq__12843__$1,temp__5720__auto__,each_fixture_fn,G__12842,G__12842__$1,env,once_fixtures,each_fixtures,vec__12839,ns,vars__$1))
);
} else {
}


var G__12860 = cljs.core.next.call(null,seq__12843__$1);
var G__12861 = null;
var G__12862 = (0);
var G__12863 = (0);
seq__12843 = G__12860;
chunk__12844 = G__12861;
count__12845 = G__12862;
i__12846 = G__12863;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12842__$1)].join('')));
