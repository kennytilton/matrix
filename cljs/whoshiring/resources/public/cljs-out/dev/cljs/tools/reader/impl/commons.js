...
var G__13411 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__13411;
continue;
} else {
return ch;
...
var vec__13412 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__13412,(0),null);
return (match === s);
});
...
var len__4736__auto___13417 = arguments.length;
var i__4737__auto___13418 = (0);
while(true){
if((i__4737__auto___13418 < len__4736__auto___13417)){
args__4742__auto__.push((arguments[i__4737__auto___13418]));

var G__13419 = (i__4737__auto___13418 + (1));
i__4737__auto___13418 = G__13419;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13415){
var G__13416 = cljs.core.first.call(null,seq13415);
var seq13415__$1 = cljs.core.next.call(null,seq13415);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13416,seq13415__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__13420__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__13420 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13421__i = 0, G__13421__a = new Array(arguments.length -  1);
while (G__13421__i < G__13421__a.length) {G__13421__a[G__13421__i] = arguments[G__13421__i + 1]; ++G__13421__i;}
  _ = new cljs.core.IndexedSeq(G__13421__a,0,null);
} 
return G__13420__delegate.call(this,rdr,_);};
G__13420.cljs$lang$maxFixedArity = 1;
G__13420.cljs$lang$applyTo = (function (arglist__13422){
var rdr = cljs.core.first(arglist__13422);
var _ = cljs.core.rest(arglist__13422);
return G__13420__delegate(rdr,_);
});
