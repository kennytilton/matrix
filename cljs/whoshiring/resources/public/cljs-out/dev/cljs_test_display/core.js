...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_12926);
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq12927){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12928,G__12929,seq12927__$2);
}));
...
var vec__12933 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__12933,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__12933,(1),null);
var G__12936 = cljs.core.PersistentArrayMap.EMPTY;
var G__12936__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__12936,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12936);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__12936__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__12936__$1;
}
} else {
...
return (function() { 
var G__12940__delegate = function (klass,contents){
var vec__12937 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__12937,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__12937,(1),null);
...
var G__12940 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__12941__i = 0, G__12941__a = new Array(arguments.length -  1);
while (G__12941__i < G__12941__a.length) {G__12941__a[G__12941__i] = arguments[G__12941__i + 1]; ++G__12941__i;}
  contents = new cljs.core.IndexedSeq(G__12941__a,0,null);
} 
return G__12940__delegate.call(this,klass,contents);};
G__12940.cljs$lang$maxFixedArity = 1;
G__12940.cljs$lang$applyTo = (function (arglist__12942){
var klass = cljs.core.first(arglist__12942);
var contents = cljs.core.rest(arglist__12942);
return G__12940__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__12946){
...
var ns = cljs.core.get.call(null,map__12947__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__12949){
...
var actual = cljs.core.get.call(null,map__12950__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__12950__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__12952){
...
var expected = cljs.core.get.call(null,map__12953__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__12953__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12955_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__12955_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__12957 = cljs_test_display.core.current_var_info.call(null);
var map__12957__$1 = (((((!((map__12957 == null))))?(((((map__12957.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12957.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12957):map__12957);
var info = map__12957__$1;
var name = cljs.core.get.call(null,map__12957__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__12957__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12957__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__12956_SHARP_){
return cljs.core.cons.call(null,node,p1__12956_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__12959){
...
var m = map__12960__$1;
var fail = cljs.core.get.call(null,map__12960__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__12960__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__12960__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__12960__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___12962 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12962)){
var message_12963 = temp__5720__auto___12962;
cljs.core.println.call(null,message_12963);
} else {
}
...
var temp__5720__auto___12964 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12964)){
var message_12965 = temp__5720__auto___12964;
cljs.core.println.call(null,message_12965);
} else {
}
