...
return cljs.core.map.call(null,(function (p1__10075_SHARP_){
return html_coll.item(p1__10075_SHARP_);
...
return cljs.core.some.call(null,(function (p1__10076_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__10076_SHARP_);
...
var ctx_10077 = cvs.getContext("2d");
(ctx_10077.fillStyle = color);

ctx_10077.fillRect((0),(0),size,size);
