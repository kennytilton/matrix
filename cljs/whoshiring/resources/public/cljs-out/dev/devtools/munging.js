...
var o16567 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16567["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16568 = temp__5718__auto____$1;
return (o16568["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15490__auto__ = f;
return (o__15490__auto__["toString"]).call(o__15490__auto__);
} else {
return "";
}
}catch (e16569){var _ = e16569;
return "";
}});
...
try{var o__15490__auto___16571 = t;
(o__15490__auto___16571["cljs$lang$ctorPrWriter"]).call(o__15490__auto___16571,t,writer);
}catch (e16570){var __16572 = e16570;
}
...
var char_code = (function (){var o__15490__auto__ = (new String(char$));
return (o__15490__auto__["charCodeAt"]).call(o__15490__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15490__auto__ = String;
return (o__15490__auto__["fromCharCode"]).call(o__15490__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16573 = num_code;
switch (G__16573) {
case (1):
return (185);
...
var o__15490__auto__ = String;
return (o__15490__auto__["fromCharCode"]).call(o__15490__auto__,superscript_code);
});
/**
...
}catch (e16575){var _e__15497__auto__ = e16575;
return false;
}})())){
...
var vec__16576 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16576,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o16579 = temp__5718__auto__;
var temp__5718__auto____$1 = (o16579["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o16580 = temp__5718__auto____$1;
return (o16580["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___16587 = arguments.length;
var i__4737__auto___16588 = (0);
while(true){
if((i__4737__auto___16588 < len__4736__auto___16587)){
args__4742__auto__.push((arguments[i__4737__auto___16588]));

var G__16589 = (i__4737__auto___16588 + (1));
i__4737__auto___16588 = G__16589;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16583){
var vec__16584 = p__16583;
var ns_detector = cljs.core.nth.call(null,vec__16584,(0),null);
...
var G__16590 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16591 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16590;
remaining_tokens = G__16591;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16581){
var G__16582 = cljs.core.first.call(null,seq16581);
var seq16581__$1 = cljs.core.next.call(null,seq16581);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16582,seq16581__$1);
}));
...
var vec__16595 = cljs.core.split_with.call(null,(function (p1__16594_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16594_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16595,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16595,(1),null);
...
var vec__16601 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16601,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16601,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16604 = cljs.core.rest.call(null,remaining_tokens);
var G__16605 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16604;
name_tokens = G__16605;
continue;
} else {
...
var vec__16608 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16608,(0),null);
var arity = cljs.core.nth.call(null,vec__16608,(1),null);
var vec__16611 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16611,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16611,(1),null);
var vec__16614 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16614,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16614,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16614,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16614,(3),null);
...
var vec__16620 = result;
var munged_ns = cljs.core.nth.call(null,vec__16620,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16620,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16620,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16620,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16620,(4),null);
var arity = cljs.core.nth.call(null,vec__16620,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__16624 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__16624,(0),null);
var args = cljs.core.nth.call(null,vec__16624,(1),null);
var vec__16627 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16627,(0),null);
var name = cljs.core.nth.call(null,vec__16627,(1),null);
...
var G__16630 = (arity + (1));
var G__16631 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16632){
var vec__16633 = p__16632;
var arity = cljs.core.nth.call(null,vec__16633,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16633,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16636_SHARP_){
return cljs.core.get.call(null,arities,p1__16636_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__16637_SHARP_){
return cljs.core.drop.call(null,(2),p1__16637_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___16644 = arguments.length;
var i__4737__auto___16645 = (0);
while(true){
if((i__4737__auto___16645 < len__4736__auto___16644)){
args__4742__auto__.push((arguments[i__4737__auto___16645]));

var G__16646 = (i__4737__auto___16645 + (1));
i__4737__auto___16645 = G__16646;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16640){
var vec__16641 = p__16640;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16641,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16638){
var G__16639 = cljs.core.first.call(null,seq16638);
var seq16638__$1 = cljs.core.next.call(null,seq16638);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16639,seq16638__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16649__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16649__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16649__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16649__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16650 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16650,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16650,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16650,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16650,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16650,(4),null);
var arity = cljs.core.nth.call(null,vec__16650,(5),null);
...
var o__15490__auto__ = f;
return (o__15490__auto__["getBasis"]).call(o__15490__auto__);
});
/**
...
}catch (e16654){var _e__15497__auto__ = e16654;
...
var G__16655 = (obj[cljs.core.first.call(null,path)]);
var G__16656 = cljs.core.rest.call(null,path);
obj = G__16655;
path = G__16656;
continue;
} else {
...
var _STAR_ = (function (accum,p__16657){
var vec__16658 = p__16657;
var bit = cljs.core.nth.call(null,vec__16658,(0),null);
var protocol = cljs.core.nth.call(null,vec__16658,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16661){
var vec__16662 = p__16661;
var ns = cljs.core.nth.call(null,vec__16662,(0),null);
var name = cljs.core.nth.call(null,vec__16662,(1),null);
var selector = cljs.core.nth.call(null,vec__16662,(2),null);
...
var post_process = (function (p__16666){
var vec__16667 = p__16666;
var munged_name = cljs.core.nth.call(null,vec__16667,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16667,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__16665_SHARP_){
return (obj[cljs.core.first.call(null,p1__16665_SHARP_)]);
}),sorted_matches);
