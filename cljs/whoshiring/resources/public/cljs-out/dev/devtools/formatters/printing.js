...
var len__4736__auto___16747 = arguments.length;
var i__4737__auto___16748 = (0);
while(true){
if((i__4737__auto___16748 < len__4736__auto___16747)){
args__4742__auto__.push((arguments[i__4737__auto___16748]));

var G__16749 = (i__4737__auto___16748 + (1));
i__4737__auto___16748 = G__16749;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16744){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16745,G__16746,seq16744__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16750_SHARP_){
return (!((cljs.core.meta.call(null,p1__16750_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__16751__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16755){var _e__15497__auto__ = e16755;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e16757){var _e__15497__auto__ = e16757;
return false;
}}
})())){
...
var _STAR_current_state_STAR__temp_val__16760 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16760);

try{var map__16761 = opts;
...
var markup_db = cljs.core.get.call(null,map__16761__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5718__auto___16766 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16766)){
var managed_print_level_16767 = temp__5718__auto___16766;
var _STAR_print_level_STAR__orig_val__16764_16768 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16765_16769 = managed_print_level_16767;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16765_16769);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__16763_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16763_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16764_16768);
}} else {
job_fn.call(null);
}
